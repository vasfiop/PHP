...
<div class="container">
    ...
    <div class="row">
        <div class="col-md order-md-1">
            ...
            <form class="needs-validation" novalidate action="doTypeEdit.php" method="POST">
                <input type="hidden" name="tid" value="<?php echo $tid; ?>">
                <div class="row">
                    <div class="col-md-6 mb-3">
                        <label for="firstName">类型名称</label>
                        <input type="text" class="form-control" id="firstName" placeholder="" value="<?php echo $row['t_name']; ?>" required name="t_name">
