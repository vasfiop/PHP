...
<div class="container">
    ...
    <div class="row">
        <div class="col-md order-md-1">
            ...
            <form class="needs-validation" novalidate method="POST" action="doChackEmail.php">
                <input name="mode" value="0" type="hidden">
                <div class="row">
                    <div class="col-md-6 mb-3">
                        <label for="email">新的绑定邮箱</label>
                        <input type="email" class="form-control" id="email" placeholder="" required name="a_email">
