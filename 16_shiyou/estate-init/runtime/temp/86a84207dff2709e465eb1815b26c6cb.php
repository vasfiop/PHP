                ...
                <div class="login-screen">
                    <div class="well">
                        <div class="login-form">
                            ...
                            <p id="profile-name" class="profile-name-card" style="color:#FFFFFF;font-size:16px;"><?php echo $site['name']; ?></p>
                    ...
                    <p class="copyright"><a href="">Powered By 至简物业</a></p>
                </div>
            </div>
        </div>
