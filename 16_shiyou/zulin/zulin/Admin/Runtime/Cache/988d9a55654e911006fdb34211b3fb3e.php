...
<form id="mainfrom" class="layui-form" style="width:80%;">
  ...
  <div class="layui-form-item layui-row layui-col-xs12">
    ...
    <div class="layui-input-block">
      <input type="text" name="name" class="layui-input width200 name" value="" lay-verify="required" placeholder="请输入车辆名称">
    </div>
  </div>
  ...
  <div class="layui-form-item layui-row layui-col-xs12">
    ...
    <div class="layui-input-block">
      <input type="text" name="chepai" class="layui-input width200 chepai" value="" lay-verify="required" placeholder="请输入车牌号">
    </div>
  </div>
  ...
  <div class="layui-form-item layui-row layui-col-xs12">
    ...
    <div class="layui-input-block">
      <input type="text" name="classify" class="layui-input width200 classify" value="" lay-verify="required" placeholder="请输入车牌类型">
    </div>
  </div>
  ...
  <div class="layui-form-item layui-row layui-col-xs12">
    ...
    <div class="layui-input-block">
      <input type="text" name="paytime" class="layui-input width200 paytime" id="paytime" placeholder="yyyy-MM-dd HH:mm:ss">
    </div>
  </div>
  ...
  <div class="layui-form-item layui-row layui-col-xs12">
    ...
    <div class="layui-input-block">
      <input type="number" name="biaozhun" class="layui-input width200 biaozhun" value="" placeholder="请输入租金标准">
    </div>
  </div>
  ...
  <div class="layui-form-item layui-row layui-col-xs12">
    ...
    <div class="layui-input-block">
      <input type="text" name="zhuangkuang" class="layui-input width600 zhuangkuang" value="" placeholder="请输入车辆状况">
    </div>
  </div>
