  ...
  <div class="layui-form-item layui-row layui-col-xs12">
    ...
    <div class="layui-form-item layui-row layui-col-xs12">
      ...
      <div class="layui-input-block" style="display: flex; align-items: center;">
        <select id="rid" name="rid" lay-filter="multi">
     ...
     var str = "";
        if (data.value==3) {
          str+='<div class="layui-form-item layui-row layui-col-xs12">'
                  ...
                  +'<div class="layui-input-block">'
                    +'<input type="text" name="sfz" class="layui-input width400 sfz" value="" lay-verify="required" placeholder="请输入身份证号">'
                  +'</div>'
                +'</div>';
          str+='<div class="layui-form-item layui-row layui-col-xs12">'
                  +'<label class="layui-form-label">司机姓名：</label>'
                  +'<div class="layui-input-block">'
                    +'<input type="text" name="kname" class="layui-input width200 kname" value="" lay-verify="required" placeholder="请输入司机姓名">'
                  +'</div>'
                +'</div>';
          str+='<div class="layui-form-item layui-row layui-col-xs12">'
                  +'<label class="layui-form-label">性别：</label>'
                  +'<div class="layui-input-block">'
                    +'<input type="text" name="sex" class="layui-input width200 sex" value="" lay-verify="required" placeholder="请输入性别">'
                  +'</div>'
                +'</div>';
          str+='<div class="layui-form-item layui-row layui-col-xs12">'
                  +'<label class="layui-form-label">出生时间：</label>'
                  +'<div class="layui-input-block">'
                    +'<input type="text" name="date" class="layui-input width200 date" value="" lay-verify="required" placeholder="请输入出生时间">'
                  +'</div>'
                +'</div>';
          str+='<div class="layui-form-item layui-row layui-col-xs12">'
                  +'<label class="layui-form-label">地址：</label>'
                  +'<div class="layui-input-block">'
                    +'<input type="text" name="address" class="layui-input width400 address" value="" lay-verify="required" placeholder="请输入地址">'
                  +'</div>'
                +'</div>';
          str+='<div class="layui-form-item layui-row layui-col-xs12">'
                  +'<label class="layui-form-label">联系方式：</label>'
                  +'<div class="layui-input-block">'
                    +'<input type="text" name="phone" class="layui-input width200 phone" value="" lay-verify="required" placeholder="请输入联系方式">'
                  +'</div>'
                +'</div>';
          str+='<div class="layui-form-item layui-row layui-col-xs12">'
                  +'<label class="layui-form-label">驾驶证号：</label>'
                  +'<div class="layui-input-block">'
                    +'<input type="text" name="jiashizheng" class="layui-input width200 jiashizheng" value="" lay-verify="required" placeholder="请输入驾驶证号">'
                  +'</div>'
                +'</div>';
        }
        if (data.value==4) {
          ...
          str+='<div class="layui-form-item layui-row layui-col-xs12">'
                  ...
                  +'<div class="layui-input-block">'
                    +'<input type="text" name="kname" class="layui-input width200 kname" value="" lay-verify="required" placeholder="请输入客户姓名">'
                  +'</div>'
                +'</div>';
          str+='<div class="layui-form-item layui-row layui-col-xs12">'
                  +'<label class="layui-form-label">性别：</label>'
