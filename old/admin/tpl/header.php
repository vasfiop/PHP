    ...
    <DIV class="row row-offcanvas row-offcanvas-left">
      <DIV class="col-xs-6 col-sm-3 col-md-2 sidebar sidebar-offcanvas" id="sidebar">
        <UL class="nav nav-sidebar">
          ...
          <!-- <LI><A class="accordion-toggle collapsed" href="#" data-toggle="collapse" data-target="#mastersubmenu1">试验的信息</A>
            <UL class="nav collapse" id="mastersubmenu1" style="padding-left: 20px;">
              <LI><A href="">最后的试验</A></LI>
              <LI><A href="">试验的查询</A></LI>
              <LI><A href="">试验</A></LI>
            </UL>
          </LI> -->
      ...
      <DIV class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main ">
        <P class="pull-left visible-xs"><BUTTON class="btn btn-primary btn-xs" type="button" data-toggle="offcanvas">Toggle</BUTTON> </P> <br> <br>